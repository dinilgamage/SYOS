...
public interface TransactionDao {
  ...
  List<Transaction> getTransactionsByDateAndType(LocalDate date, String type);
  List<Transaction> getAllTransactions(); // A list of all Transaction objects.
  List<Transaction> getAllTransactionsByType(String type); // A list of Transaction objects filtered by type.
